...
const TEAM = [
  { id: 1,  name: "Aria Patel",    role: "Creative Director",  bg: ["#8B4A6B", "#6B2A4B"] },
  { id: 2,  name: "Marco Reyes",   role: "Lead Developer",     bg: ["#6B4A8B", "#4B2A6B"] },
  { id: 3,  name: "James Carter",  role: "CEO & Founder",      bg: ["#3a3a5a", "#1a1a3a"] },
  { id: 4,  name: "Sofia Chen",    role: "UI/UX Designer",     bg: ["#8B5A2B", "#6B3A0B"] },
  { id: 5,  name: "Ryan Kim",      role: "Backend Engineer",   bg: ["#2B6B4A", "#0B4B2A"] },
  { id: 6,  name: "Priya Singh",   role: "Data Scientist",     bg: ["#6B2B2B", "#4B0B0B"] },
  { id: 7,  name: "Lucas Mendes",  role: "DevOps Engineer",    bg: ["#2B4A6B", "#0B2A4B"] },
  { id: 8,  name: "Yuki Tanaka",   role: "Mobile Developer",   bg: ["#5A4A2B", "#3A2A0B"] },
  { id: 9,  name: "Elena Rossi",   role: "Product Manager",    bg: ["#4B6B2B", "#2B4B0B"] },
  { id: 10, name: "Omar Hassan",   role: "Security Engineer",  bg: ["#6B4A2B", "#4B2A0B"] },
];
